---
title: JavaScript guide moved
description: Compatibility link for the former JavaScript guide.
---
...
- [Document state](/docs/document/state) defines visible, confirmed, and
  pending state.
- [Editor integration](/docs/document/editor-integration) defines event and
  edit-step handling.

Next: [JavaScript examples](/docs/examples/javascript).

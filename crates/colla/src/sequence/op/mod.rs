//! Functional entry points for the private scalar sequence algebra.
...
use crate::sequence::{ApplyError, Change, ComposeError, InvertError, Value};

pub use transform::transform;

/// Applies `change` to `base` and returns a new immutable Value.
///
/// Type and sequence-range compatibility are checked against `base`.
